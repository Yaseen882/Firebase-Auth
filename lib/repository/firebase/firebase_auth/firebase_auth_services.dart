...
class UserAuthentication {
  ...
  Future<void> userGoogleSignIn() async {
    ...
    try {
      ...
      if (e.code == _accountExistWithDifferentCredentials) {
        _isGoogleAccountExistWithDifferentCredentials = true;
      } else if (e.code == _invalidCredentials) {
        _isInvalidGoogleCredentials = true;
      }
    }
